...
export default class QuakesController {
    ...
    async init() {
        // use this as a place to grab the element identified by this.parent, do the initial call of this.initPos(), and 
        // display some quakes by calling this.getQuakesByRadius()
